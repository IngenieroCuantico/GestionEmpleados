    ...
    <div class="col-10 col-md-8 col-lg-6">
      ...
      <form action="{{ route('empleado.store') }}" method="post">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="telefono" name="telefono" rows="3" required></textarea>
        </div>
        <div class="form-group">
          <label for="nombre">Correo </label>
          <textarea class="form-control" id="correo" name="correo" rows="3" required></textarea>
        </div>
        <br>
